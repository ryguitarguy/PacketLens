        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-400 truncate font-mono">
                {currentFilename} ({packetCount.toLocaleString()} packets)
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {showSampleDropdown && (
                <div 
                  className="absolute right-0 mt-2 w-72 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl py-2 z-50 animate-in fade-in zoom-in-95 duration-100"
                ...
                >
                  ...
                  {SAMPLE_PCAPS.map((sample) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-xs text-slate-300 hover:bg-slate-800/80 hover:text-white transition-colors flex flex-col gap-0.5"
                    >
